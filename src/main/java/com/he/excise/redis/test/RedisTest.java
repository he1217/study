package com.he.excise.redis.test;
...
public class RedisTest {
    public static void main(String[] args) {
        Jedis jedis = new Jedis("192.168.3.235");
        ...
        // 博客的发布、修改与查看
        jedis.del("article:1:title", "article:1:content","article:1:author","article:1:time");
