...
public class ArraysUtils {
    public static void main(String[] args) {
        ...
        // 排序后再进行二分查找，否则找不到
        Arrays.sort(e1);
        System.out.println("Arrays.sort(e1)" + Arrays.toString(e1));
        System.out.println("Arrays.binarySearch(g, 'c')：");
        int s = Arrays.binarySearch(e1, 'c');
...
// *************填充fill(批量初始化)****************
        ...
        // 数组中指定范围元素重新分配值
        Arrays.fill(h1, 0, 2, 9);
        System.out.println("Arrays.fill(h1, 0, 2, 9);：");
        // 输出结果：993333666
        for (int i : h1) {
            System.out.print(i);
        }
